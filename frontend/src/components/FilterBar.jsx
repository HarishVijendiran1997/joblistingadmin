...
const FilterBar = () => {
    ...
    return (
        <>
            <div className=' w-screen h-[114px] pt-8 text-[#686868]'>
                <div className='flex items-center justify-center'>

                    <div className=' px-8 py-5 border-r-2 border-r-[#EAEAEA] flex gap-2'>
                        <div>
                    ...
                    <div className='flex justify-center items-center -mt-8'>
                        ...
                        <div className="px-8 ">
                            <label className=" justify-between w-70 font-semibold space-y-3 flex">
                                <div>
                                    Salary per Month
                                </div>
                                <div className=''>
